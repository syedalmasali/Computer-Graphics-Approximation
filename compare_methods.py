...
def main():
    ...
    # that ||q|| = 1?
    # Answer from Mohan: no they did not for the Austin paper
    ...
    # holding a constant in the denom
    ...
    #plt.plot(x, eval_rational(q_alg), label='qp without 1 set')
    plt.plot(x, eval_rational(q_geom), label='gradient descent')
    #plt.plot(x, eval_rational2(q_lstq), label='lstq with 1 set')
